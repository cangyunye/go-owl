...
export const api = {
  ...
  approveAIApproval: (id) => request('POST', `/ai/approvals/${encodeURIComponent(id)}/approve`),
  rejectAIApproval: (id) => request('POST', `/ai/approvals/${encodeURIComponent(id)}/reject`),

...
func (t *PlaybookTemplateInfoTool) Description() string {
	return "Show details of a playbook template."
}
...
func (t *PlaybookTemplateExportTool) Description() string {
	return "Export a playbook template to a YAML file."
}
...
func (t *PlaybookScaffoldTool) Description() string {
	return "Generate a playbook scaffold (basic or a specific action type)."
}
...
func (t *PlaybookStateListTool) Description() string {
	return "List playbook execution runs and their status."
}
...
func (t *PlaybookStateShowTool) Description() string {
	return "Show detailed results of a playbook run."
}
...
func (t *PlaybookGenerateTool) Description() string {
	return "Generate a playbook YAML from a natural language requirement and save it under the playbook library."
}
